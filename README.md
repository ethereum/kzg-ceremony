...
- IPFS Hosted
  - [latest version](https://latest.kzgceremony.eth.limo): references the latest version of the interface, which departs from the audited version in minor ways
  - [Audited version](https://audit.kzgceremony.eth.limo): the interface which Sigma Prime audited in November 2022. May have bugs or differences from the latest version above. [docker instructions](https://github.com/zkparty/trusted-setup-frontend/blob/main/README.md)
